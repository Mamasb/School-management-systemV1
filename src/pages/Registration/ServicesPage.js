  ...
  return (
    <div className="services-page">
      <div className="container">
        <h2 className="welcome-message">Welcome, {userFullName || "Guest"}!</h2>
        ...
        <section className="fee-structure">
          ...
          <div className="fee-list">
            ...
            <div className="fee-item">
              <span className="fee-label">Assessment Tool:</span>
              <span className="fee-amount">300 KSH</span>
            </div>
            <div className="fee-item">
        ...
        {showInvoice && invoiceDetails && (
          <div className="invoice">
            ...
            <ul>
              ...
              <li><strong>Assessment Tool:</strong> 300 KSH</li>
            ...
            <button className="edit-invoice-button" onClick={handleEditInvoice}>Edit Invoice</button>
          </div>
        )}
      </div>
    </div>
